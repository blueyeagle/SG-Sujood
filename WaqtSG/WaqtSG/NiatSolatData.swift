...
extension SampleData {
    static let niatSolat: [NiatGroup] = [
        ...
        NiatGroup("Solat Jumaat", [
            Niat(title: "Jumaat",
                 transliteration: "Usolli fardal Jumu'ati rak'ataini ma'muman lillahi ta'ala.",
        ...
        NiatGroup("Solat Jenazah", note: "Four takbir; fardhu kifayah.", [
            Niat(title: "Jenazah lelaki (male)",
                 transliteration: "Usolli 'ala haazal mayyiti arba'a takbiraatin fardhal kifaayati ma'muman lillahi ta'ala.",
            ...
            Niat(title: "Jenazah perempuan (female)",
                 transliteration: "Usolli 'ala haazihil mayyitati arba'a takbiraatin fardhal kifaayati ma'muman lillahi ta'ala.",
        ...
        NiatGroup("Qada Solat", note: "For making up a missed obligatory prayer.", [
            Niat(title: "Subuh",   transliteration: "Usolli fardas Subhi rak'ataini qadaa'an lillahi ta'ala.",
                 meaning: "I intend to pray the fardhu of Subuh, two rakaat, as qada (make-up), for Allah Ta'ala."),
            Niat(title: "Zuhur",   transliteration: "Usolli fardaz Zuhri arba'a raka'atin qadaa'an lillahi ta'ala.",
                 meaning: "I intend to pray the fardhu of Zuhur, four rakaat, as qada, for Allah Ta'ala."),
            Niat(title: "Asar",    transliteration: "Usolli fardal 'Asri arba'a raka'atin qadaa'an lillahi ta'ala.",
                 meaning: "I intend to pray the fardhu of Asar, four rakaat, as qada, for Allah Ta'ala."),
            Niat(title: "Maghrib", transliteration: "Usolli fardal Maghribi thalatha raka'atin qadaa'an lillahi ta'ala.",
                 meaning: "I intend to pray the fardhu of Maghrib, three rakaat, as qada, for Allah Ta'ala."),
            Niat(title: "Isyak",   transliteration: "Usolli fardal 'Isyaa'i arba'a raka'atin qadaa'an lillahi ta'ala.",
        ...
        NiatGroup("Solat Sunat", [
            Niat(title: "Tahajjud",
                 transliteration: "Usolli sunnatat Tahajjudi rak'ataini lillahi ta'ala.",
                 meaning: "I intend to pray the sunnah Tahajjud, two rakaat, for Allah Ta'ala."),
            Niat(title: "Taubat",
                 transliteration: "Usolli sunnatat Taubati rak'ataini lillahi ta'ala.",
                 meaning: "I intend to pray the sunnah Taubat (repentance), two rakaat, for Allah Ta'ala."),
            Niat(title: "Dhuha",
                 transliteration: "Usolli sunnatad Dhuha rak'ataini lillahi ta'ala.",
                 meaning: "I intend to pray the sunnah Dhuha, two rakaat, for Allah Ta'ala."),
            Niat(title: "Hajat",
                 transliteration: "Usolli sunnatal Haajati rak'ataini lillahi ta'ala.",
                 meaning: "I intend to pray the sunnah Hajat (of need), two rakaat, for Allah Ta'ala."),
            Niat(title: "Tarawih",
                 transliteration: "Usolli sunnatat Taraawiihi rak'ataini ma'muman lillahi ta'ala.",
                 meaning: "I intend to pray the sunnah Tarawih, two rakaat, as a follower, for Allah Ta'ala."),
            Niat(title: "Witir",
                 transliteration: "Usolli sunnatal Witri rak'ataini lillahi ta'ala.",
            ...
            Niat(title: "Tahiyyatul Masjid",
                 transliteration: "Usolli sunnatan Tahiyyatal Masjidi rak'ataini lillahi ta'ala.",
                 meaning: "I intend to pray the sunnah of greeting the mosque, two rakaat, for Allah Ta'ala."),
            Niat(title: "Istikharah",
                 transliteration: "Usolli sunnatal Istikhaarati rak'ataini lillahi ta'ala.",
